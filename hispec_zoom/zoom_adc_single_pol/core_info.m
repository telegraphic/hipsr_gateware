...
zoom_adc_single_pol_acc_len_test_addr_start   = hex2dec('01000100');
zoom_adc_single_pol_acc_len_test_addr_end     = hex2dec('010001FF');
...
zoom_adc_single_pol_dest_ip_addr_start   = hex2dec('01000200');
zoom_adc_single_pol_dest_ip_addr_end     = hex2dec('010002FF');
...
zoom_adc_single_pol_dest_port_addr_start   = hex2dec('01000300');
zoom_adc_single_pol_dest_port_addr_end     = hex2dec('010003FF');
...
zoom_adc_single_pol_fft_shift_addr_start   = hex2dec('01000400');
zoom_adc_single_pol_fft_shift_addr_end     = hex2dec('010004FF');
...
zoom_adc_single_pol_snap_quant_s_addr_addr_start   = hex2dec('01009000');
zoom_adc_single_pol_snap_quant_s_addr_addr_end     = hex2dec('010090FF');
...
zoom_adc_single_pol_snap_quant_s_bram_addr_start   = hex2dec('0100A000');
zoom_adc_single_pol_snap_quant_s_bram_addr_end     = hex2dec('0100AFFF');
...
zoom_adc_single_pol_snap_quant_s_ctrl_addr_start   = hex2dec('0100B000');
zoom_adc_single_pol_snap_quant_s_ctrl_addr_end     = hex2dec('0100B0FF');
...
zoom_adc_single_pol_snap_quant_u_addr_addr_start   = hex2dec('0100B100');
zoom_adc_single_pol_snap_quant_u_addr_addr_end     = hex2dec('0100B1FF');
...
zoom_adc_single_pol_snap_quant_u_bram_addr_start   = hex2dec('0100C000');
zoom_adc_single_pol_snap_quant_u_bram_addr_end     = hex2dec('0100DFFF');
...
zoom_adc_single_pol_snap_quant_u_ctrl_addr_start   = hex2dec('0100E000');
zoom_adc_single_pol_snap_quant_u_ctrl_addr_end     = hex2dec('0100E0FF');
...
zoom_adc_single_pol_snap_x_s_addr_addr_start   = hex2dec('0100E100');
zoom_adc_single_pol_snap_x_s_addr_addr_end     = hex2dec('0100E1FF');
...
zoom_adc_single_pol_snap_x_s_bram_addr_start   = hex2dec('0100F000');
zoom_adc_single_pol_snap_x_s_bram_addr_end     = hex2dec('0100FFFF');
...
zoom_adc_single_pol_snap_x_s_ctrl_addr_start   = hex2dec('01080000');
zoom_adc_single_pol_snap_x_s_ctrl_addr_end     = hex2dec('010800FF');
...
zoom_adc_single_pol_snap_x_u_addr_addr_start   = hex2dec('01080100');
zoom_adc_single_pol_snap_x_u_addr_addr_end     = hex2dec('010801FF');
...
zoom_adc_single_pol_snap_x_u_bram_addr_start   = hex2dec('01081000');
zoom_adc_single_pol_snap_x_u_bram_addr_end     = hex2dec('01081FFF');
...
zoom_adc_single_pol_snap_x_u_ctrl_addr_start   = hex2dec('01082000');
zoom_adc_single_pol_snap_x_u_ctrl_addr_end     = hex2dec('010820FF');
...
zoom_adc_single_pol_sync_manual_arm_addr_start   = hex2dec('01082100');
zoom_adc_single_pol_sync_manual_arm_addr_end     = hex2dec('010821FF');
...
zoom_adc_single_pol_sync_pps_arm_addr_start   = hex2dec('01082200');
zoom_adc_single_pol_sync_pps_arm_addr_end     = hex2dec('010822FF');
