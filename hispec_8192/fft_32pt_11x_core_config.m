...
function fft_32pt_11x_core_config(this_block)

  % Revision History:
  %
  %   05-Apr-2013  (00:22 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /designs/dan/13.x/designs/old/noise_diode/bb/fft_32pt_11x_core.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('fft_32pt_11x_core');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('bb/fft_32pt_11x_core.vhd');
