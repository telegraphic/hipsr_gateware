...
function fft_16k_core_config(this_block)

  % Revision History:
  %
  %   08-Jul-2011  (15:16 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /designs/dan/parkes/bb/fft_16k_core.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('fft_16k_core');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('bb/fft_16k_core.vhd');
